...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-4 lg:p-6">
//       {/* Header Section */}
//       <div className="mb-8">
...
//               className="mt-4 lg:mt-0 inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl"
//             >
...
//           {/* Stats Overview */}
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//             <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-6 transform hover:-translate-y-1 transition-all duration-300">
//               <div className="flex items-center justify-between">
//                 <div>
//                   <p className="text-blue-300 text-sm font-semibold uppercase tracking-wide">Total Courses</p>
...
//             <div className="bg-gradient-to-br from-green-500/10 to-green-600/10 backdrop-blur-sm border border-green-500/20 rounded-2xl p-6 transform hover:-translate-y-1 transition-all duration-300">
//               <div className="flex items-center justify-between">
//                 <div>
//                   <p className="text-green-300 text-sm font-semibold uppercase tracking-wide">Total Students</p>
...
//               </div>
//               <div className="flex items-center gap-1 mt-4">
//                 <BsPeople className="text-green-400" />
//                 <span className="text-green-400 text-sm font-medium">Learners</span>
//               </div>
//             </div>

//             <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-6 transform hover:-translate-y-1 transition-all duration-300">
//               <div className="flex items-center justify-between">
//                 <div>
//                   <p className="text-purple-300 text-sm font-semibold uppercase tracking-wide">Total Income</p>
...
//                 <span className="text-purple-400 text-sm font-medium">Revenue</span>
//               </div>
//             </div>
//           </div>
...
//               ) : (
//                 <div className="h-full bg-gradient-to-br from-gray-800 to-gray-700 backdrop-blur-sm border border-gray-600 rounded-2xl p-6 flex flex-col items-center justify-center">
//                   <BsGraphUp className="text-6xl text-gray-500 mb-4" />
//                   <p className="text-xl font-bold text-gray-300 text-center">Not Enough Data To Visualize</p>
//                   <p className="text-gray-400 text-center mt-2">Start teaching to see your analytics here</p>
//                 </div>
//               )}
//             </div>
...
//               <div className="bg-gradient-to-br from-gray-800 to-gray-700 backdrop-blur-sm border border-gray-600 rounded-2xl p-6">
...
//                     <span className="text-gray-300">Avg. Students/Course</span>
//                     <span className="text-white font-semibold">
//                       {courses.length > 0 ? Math.round(totalStudents / courses.length) : 0}
//                     </span>
//                   </div>
//                   <div className="flex justify-between items-center">
//                     <span className="text-gray-300">Avg. Revenue/Course</span>
//                     <span className="text-white font-semibold">
...
//               <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/10 backdrop-blur-sm border border-orange-500/20 rounded-2xl p-6">
//                 <h3 className="text-lg font-bold text-white mb-4">Quick Actions</h3>
//                 <div className="space-y-3">
//                   <Link 
//                     to="/dashboard/add-course"
//                     className="block w-full text-center py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-colors duration-200"
//                   >
//                     Create Course
//                   </Link>
//                   <Link 
//                     to="/dashboard/my-courses"
//                     className="block w-full text-center py-2 border border-orange-500 text-orange-400 hover:bg-orange-500/10 rounded-lg transition-colors duration-200"
//                   >
//                     Manage Courses
//                   </Link>
//                 </div>
...
//               <Link 
//                 to="/dashboard/my-courses"
//                 className="mt-2 lg:mt-0 inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 font-semibold transition-colors duration-200"
//               >
//                 View All Courses
...
//                 <div 
//                   key={course._id} 
//                   className="group bg-gray-800/50 backdrop-blur-sm border border-gray-600 rounded-xl overflow-hidden hover:border-blue-500/50 transition-all duration-300 transform hover:-translate-y-2"
//                 >
...
//                       <span className="inline-flex items-center gap-1 px-2 py-1 bg-blue-500/80 text-white text-xs font-semibold rounded-full">
...
//                   <div className="p-4">
//                     <h3 className="font-bold text-white line-clamp-2 group-hover:text-blue-300 transition-colors duration-200">
//                       {course.courseName}
//                     </h3>
...
//           <div className="w-32 h-32 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-full flex items-center justify-center mb-6 border border-blue-500/20">
//             <FiBook className="text-6xl text-blue-400" />
//           </div>
...
//           <Link 
//             to="/dashboard/add-course"
//             className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl"
//           >
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-richblack-800 border border-richblack-600 rounded-2xl p-6 transform hover:-translate-y-1 transition-all duration-300 hover:border-yellow-50/30 hover:shadow-xl">
              ...
              <div className="flex items-center gap-1 mt-4">
                <FiTrendingUp className="text-green-400" />
                <span className="text-green-400 text-sm font-medium italic">Active and growing</span>
              </div>
            </div>
            ...
            <div className="bg-richblack-800 border border-richblack-600 rounded-2xl p-6 transform hover:-translate-y-1 transition-all duration-300 hover:border-yellow-50/30 hover:shadow-xl">
              ...
              <div className="flex items-center gap-1 mt-4">
                <BsPeople className="text-green-400" />
                <span className="text-green-400 text-sm font-medium italic">Amazing learners</span>
              </div>
            </div>
            ...
            <div className="bg-richblack-800 border border-richblack-600 rounded-2xl p-6 transform hover:-translate-y-1 transition-all duration-300 hover:border-yellow-50/30 hover:shadow-xl">
              ...
              <div className="flex items-center gap-1 mt-4">
                ...
                <span className="text-green-400 text-sm font-medium italic">Impressive revenue</span>
              </div>
            </div>
          </div>
